              ...
              replacement: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: CFCAppText(
                      text:
                      'It looks like you haven\'t left a feedback yet for any learning material as yet.',
              ...
              child: CFCCard(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      onTap: () {
                        if (details.isFeedbackCompleted) {
                          Get.to(() => ViewFeedback(details: details));
                        } else {
                          Get.to(() => ViewMyCourse(myCourses: details));
                        }
                      },
                      child: Container(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: CFCAppText(
                                          text: details.isFeedbackCompleted ? 'Completed' : 'Pending',
                                          fontWeight: FontWeight.w400,
                                          color: CFCAppColors.textColorDark.withOpacity(0.6),
                                        ),
                                      ),
                                      // const SizedBox(width: 10.0),
                                      // CFCAppText(
